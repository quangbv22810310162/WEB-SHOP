...
let initwebRoutes = (app) => {
    ...
    //==================API EMAIL=========================//
    router.post('/api/send-contact-email', emailController.sendContactFormEmail);
    router.post('/api/send-newsletter-email', emailController.sendNewsletterEmail);
    ...
    //=================API AI ASSISTANT============================//
    router.post('/api/assistant/chat', assistantController.chatWithAssistant)
    //==================API COMMENT============================//
