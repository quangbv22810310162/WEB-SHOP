...
function InfoDetailProduct(props) {
    ...
    let handleAddShopCart = () => {
        ...
        if (quantityProduct > quantity) {
            toast.error(`Chỉ còn ${quantity} sản phẩm`)
            return;
        }
        ...
        dispatch(addItemCartStart({
            ...
            quantity: parseInt(quantityProduct) || 1,
        }))
    }
    return (
                ...
                <div className="s_product_text">
                    ...
                    <ul className="list">
                        <li>
                            <a className="active" href="#">
                                <span>Loại sản phẩm:</span> : {dataProduct && dataProduct.categoryData ? dataProduct.categoryData.value : ''}</a>
                        </li>
                        <li>
                    ...
                    <div style={{ display: 'flex' }}>
                        <div className="product_count">
                            ...
                            <input type="number" value={quantityProduct} onChange={(event) => {
                                const value = parseInt(event.target.value) || 1;
                                setquantityProduct(value > 0 ? value : 1);
                            }} min="1" max={quantity || 1} />

                        </div>
                        <div className="form-group">
                            <label style={{ fontSize: '14px', color: '#797979', fontFamily: '"Roboto",sans-serif', marginLeft: '16px' }} htmlFor="type">Màu sắc:</label>
                    ...
                    <div className="card_area">
                        <a className="main_btn" onClick={() => handleAddShopCart()}>Thêm vào giỏ hàng</a>
