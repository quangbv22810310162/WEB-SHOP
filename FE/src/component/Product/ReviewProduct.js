...
function ReviewProduct(props) {
    ...
    let handleSaveComment = async () => {
        if (!inputValues.activeStar) toast.error("Bạn chưa đánh giá")
        else if (!inputValues.content) toast.error("Nội dung không thể trống!")
        else {
                ...
                <div className="row total_rate">
                    <div className="col-6">
                        <div className="box_total">
                            ...
                            <h6>({inputValues.countStar.quantity} đánh giá)</h6>
                        </div>
                    </div>
                    <div className="col-6">
                        <div className="rating_list">
                            <h3>{inputValues.countStar.quantity} đánh giá</h3>
                            <ul className="list">
                                <li>
                                    <a href="#">5
                                        ...
                                        <i className="fa fa-star" />
                                        <i className="fa fa-star" />
                                        <i className="fa fa-star" /> Có {inputValues.countStar.star5} đánh giá</a>
                                </li>
                                <li>
                                    <a href="#">4
                                        <i className="fa fa-star" />
                                        ...
                                        <i className="fa fa-star" /> Có {inputValues.countStar.star4} đánh giá</a>
                                </li>
                                <li>
                                    <a href="#">3
                                        <i className="fa fa-star" />
                                        ...
                                        <i className="fa fa-star" /> Có {inputValues.countStar.star3} đánh giá</a>
                                </li>
                                <li>
                                    <a href="#">2
                                        <i className="fa fa-star" />

                                        <i className="fa fa-star" /> Có {inputValues.countStar.star2} đánh giá</a>
                                </li>
                                <li>
                                    <a href="#">1

                                        <i className="fa fa-star" /> Có {inputValues.countStar.star1} đánh giá</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="review_item">
                            ...
                            <div className="content-review">
                                ...
                                <div className="content-right">
                                    <button onClick={() => handleSaveComment()} className="btn btn-primary"><i className="fas fa-pencil-alt"></i> Chia sẻ</button>
                                </div>
                            </div>
