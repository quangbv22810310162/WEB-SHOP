                        ...
                        <div className="collapse navbar-collapse offset w-100" id="navbarSupportedContent">
                            <div className="row w-100 mr-0">
                                <div className="col-lg-9 pr-0">
                                    <ul className="nav navbar-nav center_nav pull-left">
                                        <li className="nav-item">
                                            <NavLink exact to="/" className="nav-link"
                                                activeClassName="selected" activeStyle={{ color: '#ff4674' }}>
                                                Trang chủ
                                            </NavLink>
                                        </li>
                                        <li className="nav-item ">
                                        ...
                                        <li className="nav-item">
                                            <NavLink to="/contact" className="nav-link" activeClassName="selected" activeStyle={{ color: '#ff4674' }}>
                                                Liên hệ
                                            </NavLink>
                                        </li>
                                    </ul>
                                    ...
                                    <ul className="nav navbar-nav navbar-right right_nav pull-right">
                                        ...
                                        <li className="nav-item">
                                            <Link to={"/shopcart"} className="icons">
                                                <span className="box-quantity-cart" style={{marginTop:'15px',marginLeft:'5px'}}>{dataCart && dataCart.length}</span>
