...
function OrderHomePage(props) {
    ...
    useEffect(() => {
        ...
        fetchExchangeRate()
        fetchTypeShip()
        loadDataAddress(userId)
    }, [userId])

    // Tự động chọn VNPAY khi chọn thanh toán online
    useEffect(() => {
        if (activeTypePayment === 1) {
            setactiveTypeOnlPayment(2);
        }
    }, [activeTypePayment])
    ...
    let handleSaveOrder = async () => {
        ...
        if (!dataTypeShip.id) {
            ...
            if (activeTypePayment == 0) {
                ...
                // Luôn sử dụng VNPAY khi thanh toán online
                history.push({
                                    ...
                                    <table className="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style={{ textAlign: 'center' }} scope="col">Tổng</th>
                            ...
                            <div className="box-shopcart-bottom">
                                <div className="content-left">
                                    <div className="wrap-voucher">
                                        ...
                                        <span className="name-easier">Mã giảm giá</span>
                                        <span onClick={() => handleOpenModal()} className="choose-voucher">Chọn Voucher</span>
                                    ...
                                    <div className="wrap-note">
                                        <span>Lời nhắn:</span>
                                        <input value={note} onChange={(event) => setnote(event.target.value)} type="text" placeholder="Ghi chú cho người bán..." />
                                    </div>
                                </div>
                                <div className="content-right">
                    ...
                    <div className="content-top">
                        ...
                        {activeTypePayment != 0 &&
                            <div className='box-payment'>
                                ...
                                <div onClick={() => setactiveTypeOnlPayment(2)} className='box-type-payment activeOnl'>Thanh toán VNPAY</div>
                            </div>
                        }
                    ...
                    <div className="content-bottom">
                        <div className="wrap-bottom">
                            <div className="box-flex">
                                <div className="head">Tổng giá sản phẩm</div>
