                                    ...
                                    <div className='box-list-order'>
                                        <div className='content-top'>
                                            <div className='content-left'>
                                                ...
                                                <span className='label-name-shop'>Cardina Fashion</span>
                                                <div className='view-shop'>
                                                    <i className="fas fa-store"></i>

                                                    <a style={{ color: 'black' }} href='/shop'>Xem cửa hàng</a>
                                                </div>
                                            </div>
                                                    ...
                                                    <div className='content-center'>
                                                        <div className='box-item-order'>
                                                            ...
                                                            <div className='box-des'>
                                                                ...
                                                                <span className='type'>Phân loại sản phẩm: {item.productDetail.nameDetail} | {item.productDetailSize.sizeData.value}</span>
