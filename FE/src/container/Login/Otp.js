            ...
            <div className="container d-flex justify-content-center align-items-center container_Otp">
                <div className="card text-center">
                    <div className="card-header p-5">
                        ...
                        <div>
                            <small>OTP has been sent to phone number {props.dataUser && props.dataUser.phonenumber}</small>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        You did not receive OTP?
                            <a onClick={() => resendOTP()} style={{ color: '#3366FF' }} className="text-decoration-none ml-2">Resend OTP</a>
                        </small>
                    </div>
                    <div className="mt-3 mb-5">
                        <div id="sign-in-button"></div>
                        <button onClick={() => submitOTP()} className="btn btn-success px-4 verify-btn">Submit</button>
                    </div>
                </div>
            </div>
