    ...
    return (
        ...
        <div className="ks-header">
          <div className="ks-description">
            <div className="ks-name">Tên đoạn chat</div>
            <div className="ks-amount">2 thành viên</div>
          </div>
          <div className="ks-controls">
            <div className="dropdown">
              <button className="btn btn-primary-outline ks-light ks-no-text ks-no-arrow" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span className="la la-ellipsis-h ks-icon" /><i class="fas fa-bars"></i>
              </button>
              <div className="dropdown-menu dropdown-menu-right ks-simple" aria-labelledby="dropdownMenuButton">
                <a className="dropdown-item" href="#">
                  ...
                  <span className="ks-text">Thêm thành viên</span>
                </a>
                <a className="dropdown-item" href="#">
                  <span className="la la-eye-slash ks-icon" />
                  <span className="ks-text">Đánh dấu chưa đọc</span>
                </a>
                <a className="dropdown-item" href="#">
                  <span className="la la-bell-slash-o ks-icon" />
                  <span className="ks-text">Tắt thông báo</span>
                </a>
                <a className="dropdown-item" href="#">
                  <span className="la la-mail-forward ks-icon" />
                  <span className="ks-text">Chuyển tiếp</span>
                </a>
                <a className="dropdown-item" href="#">
                ...
                <a className="dropdown-item" href="#">
                  ...
                  <span className="ks-text">Xóa</span>
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="ks-footer">
          <textarea onChange={(e) => setMessage(e.target.value)} value={message} className="form-control" placeholder="Nhập tin nhắn..." defaultValue={""} />
          <div className="ks-controls">
