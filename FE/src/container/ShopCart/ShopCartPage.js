                            ...
                            <tbody>
                                ...
                                {dataCart && dataCart.length > 0 ? (
                                    dataCart.map((item, index) => {
                                        if (!item.productDetail || !item.productData || !item.productdetailsizeData || !item.productDetailImage || item.productDetailImage.length === 0) {
                                            return null;
                                        }
                ...
                <div className="box-shopcart-bottom">
                    ...
                    <div className="content-right">
                        ...
                        <div className="checkout_btn_inner">
                            <a onClick={() => handleOpenAddressUserModal()} className="main_btn">Tiến hành thanh toán</a>
                        </div>
                    </div>
                </div>
            </div>
