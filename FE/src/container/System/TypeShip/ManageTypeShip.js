...
const ManageTypeShip = () => {
    ...
    let handleDeleteTypeShip = async (id) => {
        ...
        if (res && res.errCode === 0) {
            toast.success("Xóa loại giao hàng thành công!")
            let arrData = await getAllTypeShip({
                limit: PAGINATION.pagerow,
        ...
        } else toast.error("Xóa loại giao hàng thất bại!")
    }
    ...
    let handleOnClickExport = async () => {
        ...
        if (res && res.errCode == 0) {
            await CommonUtils.exportExcel(res.data, "List Type Shipping", "ListTypeShip")
        }

    }
    return (
        <div className="container-fluid px-4">
            <h1 className="mt-4">Quản lý phương thức giao hàng</h1>
            ...
            <div className="card mb-4">
                ...
                <div className="card-body">
                    ...
                    <div className='row'>
                        <div className='col-4'>
                            <FormSearch title={"Tên loại giao hàng"} handleOnchange={handleOnchangeSearch} handleSearch={handleSearchTypeShip} />
                        </div>
                        <div className='col-8'>
