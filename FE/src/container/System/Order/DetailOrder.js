            ...
            <div className="wrap-order">
                                    ...
                                    <table className="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style={{ textAlign: 'center' }} scope="col">Tổng cộng</th>
                            ...
                            <div className="box-shopcart-bottom">
                                <div className="content-left">
                                    ...
                                    <div className="wrap-note">
                                        <span>Tin nhắn:</span>
                                        <input value={DataOrder.note} type="text" placeholder="Ghi chú cho người bán..." />
                                    </div>
                                </div>
                ...
                <div className="wrap-payment">
                    <div className="content-top" style={{ display: 'flex', gap: '10px' }}>
                        ...
                        <div className='box-type-payment active'>{DataOrder.isPaymentOnlien == 0 ? 'Thanh toán tiền mặt' : 'Thanh toán trực tuyến'}</div>
                        ...
                        <div className="wrap-bottom">
                            ...
                            <div className="box-flex">
                                {DataOrder && DataOrder.statusId == 'S3' &&
                                    ...
                                    <a onClick={() => handleAcceptOrder()} className="main_btn">Xác nhận đơn hàng</a>

                                }
                                {DataOrder && DataOrder.statusId == 'S4' &&
                                    <a onClick={() => handleSendProduct()} className="main_btn">Giao hàng</a>
                                }
                            ...
                            {(DataOrder && DataOrder.statusId == 'S3' && DataOrder.isPaymentOnlien == 0)
                                &&
                                <a onClick={() => handleCancelOrder(DataOrder)} style={{ marginLeft: '30px', background: '#cd2b14', border: '1px solid #cd2b14', width: '213px' }} className="main_btn">Hủy đơn hàng</a>
                            }
