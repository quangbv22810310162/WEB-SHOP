...
const ManageBrand = () => {
    ...
    let handleDeleteBrand = async (event, id) => {
        ...
        } else toast.error("Xóa thương hiệu thất bại")
    }
    ...
    let handleOnClickExport =async () =>{
        ...
        if(res && res.errCode == 0){
            await CommonUtils.exportExcel(res.data,"Danh sách thương hiệu","ListBrand")
        }
        ...
        <div className="container-fluid px-4">
            ...
            <div className="card mb-4">
                ...
                <div className="card-body">
                    ...
                    <div className='row'>
                    <div  className='col-4'>
                    <FormSearch title={"Tên thương hiệu"}  handleOnchange={handleOnchangeSearch} handleSearch={handleSearchBrand} />
                    </div>
                    <div className='col-8'>
