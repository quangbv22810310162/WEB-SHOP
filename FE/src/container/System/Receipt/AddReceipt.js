...
const AddReceipt = (props) => {
    ...
    let handleSaveReceipt = async () => {
            ...
            else toast.error("Thêm đơn nhập hàng thất bại!")
            ...
            <div className="card mb-4">
                ...
                <div className="card-body">
                    <form>
                        ...
                        <button type="button" onClick={() => handleSaveReceipt()} className="btn btn-primary">Lưu</button>
                    </form>
                </div>
            </div>
        </div>
