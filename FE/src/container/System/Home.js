    ...
    <div className="container-fluid px-4">
      ...
      <div className="row">
        <div className="col-xl-3 col-md-6">
          <div className="card bg-success text-white mb-4">
            ...
            <div className="card-footer d-flex align-items-center justify-content-between">
              <Link to={'/admin/list-product'} className="small text-white stretched-link">Chi tiết</Link>
        ...
        <div className="col-xl-3 col-md-6">
          <div className="card bg-primary text-white mb-4">
            <div className="card-body">TỔNG ĐƠN HÀNG ({CountCard.countOrder})</div>
            <div className="card-footer d-flex align-items-center justify-content-between">
              <Link to={'/admin/list-order'} className="small text-white stretched-link">Chi tiết</Link>
              <div className="small text-white"><i className="fas fa-angle-right"></i></div>
            </div>
          </div>
        </div>
        <div className="col-xl-3 col-md-6">
          <div className="card bg-danger text-white mb-4">
            ...
            <div className="card-footer d-flex align-items-center justify-content-between">
              <Link to={'/admin/list-user'} className="small text-white stretched-link">Chi tiết</Link>
              <div className="small text-white"><i className="fas fa-angle-right"></i></div>
            </div>
          </div>
        </div>
      ...
      <div className="col-md-4">
        ...
        <div className="col-md-8">
          ...
          />
          <Line options={getOptions('Biểu đồ doanh thu theo tháng trong năm')} data={dataLine} />
        </div>
      ...
      <div className='row'>
        <div className='col-sm-11'>
          ...
          <DatePicker
            ...
            className='form-control col-md-2'
          />
          <Bar options={getOptions('Theo ngày trong tháng')} data={dataBar} />
        </div>
