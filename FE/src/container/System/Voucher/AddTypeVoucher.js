    ...
    let handleSaveTypeVoucher = async () => {
        if (isActionADD === true) {
            ...
            if (res && res.errCode === 0) {
                ...
                toast.error(res.errMessage || "Thêm loại voucher thất bại")
            }
            ...
            if (res && res.errCode === 0) {
                ...
                toast.error(res.errMessage || "Cập nhật loại voucher thất bại")
            }
            ...
            <div className="card mb-4">
                ...
                <div className="card-body">
                    <form>
                        ...
                        <button type="button" onClick={() => handleSaveTypeVoucher()} className="btn btn-primary">Lưu</button>
                    </form>
                </div>
            </div>
        </div>
