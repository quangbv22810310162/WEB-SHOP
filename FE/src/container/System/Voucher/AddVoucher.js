    ...
    let handleSaveInforVoucher = async () => {
        if (inputValues.isActionADD === true) {
            ...
            if (response && response.errCode === 0) {
                ...
                toast.error(response.errMessage || "Tạo mã giảm giá thất bại")
            }
        } else {
            ...
            } else toast.error(response.errMessage || "Cập nhật mã giảm giá thất bại")
        }
    }
    return (
        <div className="container-fluid px-4">
            ...
            <div className="card mb-4">
                <div className="card-header">
                    ...
                    {inputValues.isActionADD === true ? 'Thêm mới mã giảm giá' : 'Cập nhật thông tin mã giảm giá'}
                </div>
                <div className="card-body">
                    <form>
                        <div className="form-row">
                            ...
                            <div className="form-group col-md-4">
                                <label htmlFor="inputPassword4">Số lượng</label>
                        ...
                        <button onClick={() => handleSaveInforVoucher()} type="button" className="btn btn-primary">Lưu</button>
                    </form>
                </div>
            </div>
        </div>
