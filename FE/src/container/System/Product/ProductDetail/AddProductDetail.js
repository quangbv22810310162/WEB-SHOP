...
const AddProductDetail = (props) => {
    ...
    let handleOnChangeImage = async (event) => {
        ...
        if(file.size > 31312281){
            toast.error("File size is less than 30mb")
        }
        else{
                    ...
                    <form>
                        <div className="form-row">
                            ...
                            <div className="form-group col-md-3">
                                <label htmlFor="inputEmail4">Giá</label>
                            ...
                            <div className="form-group col-md-4">
                                <label htmlFor="inputPassword4">Cân nặng</label>
                        ...
                        <div className="form-group col-md-4">
                            ...
                            <div className="form-group col-md-3">
                                ...
                                />
                                <label style={{ backgroundColor: '#eee', borderRadius: '5px', padding: '6px', cursor: 'pointer' }} className="label-upload" htmlFor="previewImg">Tải lên <i className="fas fa-upload"></i></label>
                                <div style={{ backgroundImage: `url(${inputValues.imageReview})` }} onClick={() => openPreviewImage()} className="box-image"></div>
                            </div>
                        </div>

                        <button onClick={() => handleSaveProductDetail()} type="button" className="btn btn-primary">Lưu</button>
                    </form>
                </div>
            </div>
