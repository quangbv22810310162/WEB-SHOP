...
const AddProduct = (props) => {
    ...
    let handleOnChangeImage = async (event) => {
        ...
        if(file.size > 31312281){
            toast.error("Dung lượng file không được quá 30MB")
        }
        else{
                ...
                <div className="card-body">
                    <form>
                        <div className="form-row">
                            ...
                            <div className="form-group col-md-4">
                                <label htmlFor="inputPassword4">Xuất xứ</label>
                        ...
                        <div className="form-row">
                            ...
                            <div className="form-group col-md-6">
                                <label htmlFor="inputPassword4">Thương hiệu</label>
                        ...
                        <div className="form-row">
                            ...
                            <div className="form-group col-md-4">
                                <label htmlFor="inputEmail4">Cân nặng</label>
                        ...
                        <button onClick={() => handleSaveProduct()} type="button" className="btn btn-primary">Lưu</button>
                    </form>
                </div>
            </div>
