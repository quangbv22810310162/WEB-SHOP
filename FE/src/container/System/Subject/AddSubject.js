        ...
        <div className="container-fluid px-4">
            ...
            <div className="card mb-4">
                <div className="card-header">
                    ...
                    {isActionADD === true ? 'Thêm chủ đề mới' : 'Cập nhật thông tin chủ đề'}
                </div>
                <div className="card-body">
                    <form>
                        <div className="form-row">
                            ...
                            <div className="form-group col-md-6">
                                <label htmlFor="inputPassword4">Mã</label>
                        ...
                        <button type="button" onClick={() => handleSaveSubject()} className="btn btn-primary">Lưu</button>
                    </form>
                </div>
            </div>
        </div>
