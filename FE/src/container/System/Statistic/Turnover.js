        ...
        if (res && res.errCode == 0) {
            ...
            res.data.forEach(item => {
                arrayObject.push({
                    ...
                    paymentType: item.isPaymentOnlien == 0 ? 'Thanh toán tiền mặt' : 'Thanh toán trực tuyến',
        ...
        <div className="container-fluid px-4">
            ...
            <div className="card mb-4">
                ...
                <div className="card-body">
                                    ...
                                    dataOrder.map((item, index) => {
                                        ...
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td>{item.isPaymentOnlien == 0 ? 'Thanh toán tiền mặt' : 'Thanh toán trực tuyến'}</td>
                    ...
                    <span style={{ color: '#ff4674', fontSize: '26px' }} className="text-price">{CommonUtils.formatter.format(totalPrice)}</span>
                </div>
            </div>
        </div>
    )
