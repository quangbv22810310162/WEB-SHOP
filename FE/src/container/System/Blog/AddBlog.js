...
const AddBlog = (props) => {
    ...
    let handleSaveBlog = async () => {
        if (inputValues.isActionADD === true) {
            ...
            } else toast.error("Tạo bài viết mới thất bại")
        } else {
            ...
            } else toast.error("Cập nhật bài viết thất bại")
        }
    }
    ...
    return (
        <div className="container-fluid px-4">
            <h1 className="mt-4">Quản lý bài viết</h1>


            <div className="card mb-4">
                <div className="card-header">
                    <i className="fas fa-table me-1" />
                    {inputValues.isActionADD === true ? 'Tạo bài viết mới' : 'Cập nhật thông tin bài viết'}
                </div>
                <div className="card-body">
                    <form>
                        <div className="form-row">
                            <div className="form-group col-md-3">
                                <label htmlFor="inputEmail4">Tiêu đề</label>
                            ...
                            <div className="form-group col-md-12">
                                <label htmlFor="inputAddress">Nội dung bài viết</label>
                                <MdEditor
                                    style={{ height: '500px' }}
