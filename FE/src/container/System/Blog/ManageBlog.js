...
const ManageBlog = () => {
    ...
    let handleOnClickExport =async () =>{
        ...
        if(res && res.errCode == 0){
            ...
            await CommonUtils.exportExcel(res.data,"Danh sách bài viết","DanhSachBaiViet")
        }
                                    ...
                                    dataBlog.map((item, index) => {
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td style={{ width: '20%' }}>
                                                    <Link to={`/admin/edit-blog/${item.id}`}>Sửa</Link>
                                                    &nbsp; &nbsp;

                                                    <span onClick={() => handleDeleteBlog(item.id)} style={{ color: '#0E6DFE', cursor: 'pointer' }} >Xóa</span>
