...
const getAllProductshirt = (data) => {
    return axios.get(`/api/get-all-product-user?categoryId=shirt&brandId=&keyword=`);
};
const getAllProductdress = (data) => {
    return axios.get(`/api/get-all-product-user?categoryId=dresss&brandId=&keyword=`);
};
const getAllProductTrousers = (data) => {
    return axios.get(`/api/get-all-product-user?categoryId=Trousers&brandId=&keyword=`);
};
...
//======================AI ASSISTANT============================//
const chatWithShoppingAssistant = (data) => {
    return axios.post(`/api/assistant/chat`, data)
}
// userService.js


export {
    getAllUsers, getAllCodeService, createNewUser, DeleteUserService, getDetailUserById, UpdateUserService,deleteProductService,
    createAllCodeService, getDetailAllcodeById, UpdateAllcodeService, DeleteAllcodeService, handleLoginService,
    handleSendVerifyEmail, handleVerifyEmail, handleChangePassword, CreateNewProduct, getAllProductUser, getAllProductAdmin,getAllProductshirt,getAllProductTrousers,getAllProductdress,
    ...
    getStatisticStockProduct, getExchangeRate, paymentOrderVnpayService, confirmOrderVnpay, paymentOrderVnpaySuccessService, chatWithShoppingAssistant
}